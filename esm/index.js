 ...
 */
function pad(num, leftPadding, rightPadding) {
    var numAsArray = String(num).split(".");
    ...
    var outputNum = numAsArray[0];
    var paddingNeeded = leftPadding - outputNum.length;
...
export { GOLDENRATIO, ceil, decimalToHex, degToRad, floor, interest, mortage, pad, radToDeg, round, tax, toDollars, withTax };
